## 3.1.0 [unreleased]
* Rails 5 doesn't allow Rubies before 2.2.2, let's not test them. [#3177](https://github.com/refinery/refinerycms/pull/3177). [Philip Arndt](https://github.com/parndt)
